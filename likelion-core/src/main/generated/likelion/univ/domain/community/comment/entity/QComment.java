...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = 94721957L;
    ...
    public final likelion.univ.domain.community.post.entity.QPost post;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new likelion.univ.domain.community.post.entity.QPost(forProperty("post"), inits.get("post")) : null;
    }
